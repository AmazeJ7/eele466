...
-- File Name: C:\466\JG\Lab3\hdl_coder_Madgwick_normalize\codegen\Madgwick_normalize\hdlsrc\Madgwick_normalize_fixpt_enb.vhd
-- Created: 2018-02-06 13:36:38
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: Madgwick_normalize_fixpt_enb
-- Source Path: 
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
...
ENTITY Madgwick_normalize_fixpt_enb IS
  PORT( clk_1                             :   IN    std_logic;
        reset_x_1                         :   IN    std_logic;
        clk_enable_1                      :   IN    std_logic;
        clk_enable_2                      :   OUT   std_logic
        );
END Madgwick_normalize_fixpt_enb;


ARCHITECTURE rtl OF Madgwick_normalize_fixpt_enb IS
